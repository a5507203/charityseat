...
import { zipSync, strToU8 } from '../jsm/libs/fflate.module.js';
...
function MenubarFile( editor ) {
	...
	option.onClick( async function () {
		...
		var { ColladaExporter } = await import( '../jsm/exporters/ColladaExporter.js' );
	...
	option.onClick( async function () {
		...
		var { DRACOExporter } = await import( '../jsm/exporters/DRACOExporter.js' );
	...
	option.onClick( async function () {
		...
		var { GLTFExporter } = await import( '../jsm/exporters/GLTFExporter.js' );
	...
	option.onClick( async function () {
		...
		var { OBJExporter } = await import( '../jsm/exporters/OBJExporter.js' );
	...
	option.onClick( async function () {
		...
		var { PLYExporter } = await import( '../jsm/exporters/PLYExporter.js' );
	...
	option.onClick( async function () {
		...
		var { STLExporter } = await import( '../jsm/exporters/STLExporter.js' );
	...
	option.onClick( async function () {
		...
		var { USDZExporter } = await import( '../jsm/exporters/USDZExporter.js' );
	...
	option.onClick( function () {
		...
		loader.load( './jsm/webxr/VRButton.js', function ( content ) {
