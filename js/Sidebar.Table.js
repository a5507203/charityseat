...
import { UISpan, UIPanel, UIRow, UIInput, UIButton, UIColor, UICheckbox, UIInteger, UITextArea, UIText, UINumber } from './libs/ui.js';
...
import { SidebarTableAdd } from './Sidebar.Tables.Add.js';
...
function SidebarEditTable( editor ) {
	...
	objectContainer.add( objectUUIDRow );
	...
	// objectContainer.add( objectRotationRow );
	...
	// objectContainer.add( objectScaleRow );
	...
	objectContainer.add( objectFovRow );
	...
	objectContainer.add( objectLeftRow );
	...
	objectContainer.add( objectRightRow );
	...
	objectContainer.add( objectTopRow );
	...
	objectContainer.add( objectBottomRow );
	...
	objectContainer.add( objectNearRow );
	...
	objectContainer.add( objectFarRow );
	...
	objectContainer.add( objectIntensityRow );
	...
	objectContainer.add( objectColorRow );
	...
	objectContainer.add( objectGroundColorRow );
	...
	objectContainer.add( objectDistanceRow );
	...
	objectContainer.add( objectAngleRow );
	...
	objectContainer.add( objectPenumbraRow );
	...
	objectContainer.add( objectDecayRow );
	...
	objectContainer.add( objectShadowRow );
	...
	objectContainer.add( objectShadowBiasRow );
	...
	objectContainer.add( objectShadowNormalBiasRow );
	...
	objectContainer.add( objectShadowRadiusRow );
	...
	objectContainer.add( objectVisibleRow );
	...
	objectContainer.add( objectFrustumCulledRow );
	...
	objectContainer.add( objectRenderOrderRow );
