...
function SidebarArrangeTableDetails( editor, tables, guests ) {
	...
	// var objectName = new UIText().setWidth( '140px' ).setFontSize( '12px' ).onChange( function () {
...
export { SidebarArrangeTableDetails };
